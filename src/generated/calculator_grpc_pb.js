...
function serialize_calculator_PrimeNumberCompositionRequest(arg) {
  if (!(arg instanceof calculator_pb.PrimeNumberCompositionRequest)) {
    throw new Error('Expected argument of type calculator.PrimeNumberCompositionRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_calculator_PrimeNumberCompositionRequest(buffer_arg) {
  return calculator_pb.PrimeNumberCompositionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var CalculatorService = exports.CalculatorService = {
  ...
  primeNumberComposition: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: calculator_pb.PrimeNumberCompositionRequest,
    responseType: calculator_pb.PrimeNumberDecompositionResponse,
    requestSerialize: serialize_calculator_PrimeNumberCompositionRequest,
    requestDeserialize: deserialize_calculator_PrimeNumberCompositionRequest,
